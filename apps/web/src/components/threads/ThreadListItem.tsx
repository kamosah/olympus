  ...
  return (
    <ListItem>
      <Link
        ...
        className="flex items-start justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors text-left w-full block"
      >
        <div className="flex-1 min-w-0">
          <Typography
            variant="small"
            className="text-gray-900 truncate [&:not(:first-child)]:mt-0"
          >
            {thread.queryText}
          </Typography>
          <Typography
            variant="muted"
            className="mt-1 [&:not(:first-child)]:mt-1"
          >
